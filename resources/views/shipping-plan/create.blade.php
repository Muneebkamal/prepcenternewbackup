...
<div class="container-fluid">
    <div class="row d-flex align-items-center">
        <div class="col-md-6">
            <h1 class="mb-3">Shipping Plan - {{ $nextId }}</h1>
        </div>
    ...
    <input type="hidden" name="ship_plan_id" id="ship_plan_id" value="{{ $nextId  }}">
      ...
      <div class="card-body">
        ...
        <div class="row g-3">
            <div class="col-md-2">
                ...
                <div class="form-check">
                    <input class="form-check-input" type="radio" name="sku_method" value="file" id="skuFile">
            ...
            <div class="col-md-2">
                ...
                <div class="form-check ">
                    ...
                    <label class="form-check-label" for="casePack">
