...
<div class="container-fluid">
    ...
    <div class="mb-3"> 
        <form id="search_form" action="{{ route('employee.search') }}" method="POST" class="">
            @csrf
                   ...
                   <div class="table-responsive">
                        <table id="employeeTable" class="table align-middle" style="width:100%">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td> <span class="d-none">{{ $employee->date }}</span> <a href="{{ url('daily-input', $employee->id) }}" target="_blank">
                                        {{ Carbon::parse($employee->date)->format('D, F j, Y') }}
                                    </a>
                                    </td>
