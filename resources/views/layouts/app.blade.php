...
<head>
    ...
    <style>
        ...
        a {
            color: #007BFF; /* New color for anchor text */
        ...
        a:hover {
            ...
            text-shadow: 0 0 5px rgba(0, 123, 255, 0.5); /* Subtle glow effect on hover */
            /* text-decoration: underline; Adds underline on hover */
        }

        a:active {
            color: #003d80; /* Even darker shade when active */
            text-shadow: none; /* Removes glow effect when active */
        }

        a:focus {
            outline: none; /* Removes default browser outline */
            box-shadow: 0 0 0 2px rgba(0, 123, 255, 0.5); /* Adds a focus ring for accessibility */
        }

        /* Optional: Anchor tags within specific container */
        .container a {
            color: #28a745; /* Different color for links inside a specific container */
        }
    </style>
    @yield('styles')
</head>
...
<body>
    ...
    <script>
        var userPerPageLength = @json(auth()->user()->per_page ?? 10); // Get per_page from the 
